...
//
// Scope:
// - Most exercises in this set are confined to vectors of integers for
// simplicity.
// - Exercises are centered around basic functional techniques since they are
// easy to express with template metaprogramming.
//
// How to solve it:
// - You should be able to compile with gcc version 10.2, g++ --std=c++20
// typelevel_set1.cpp
...
//      in this set we'll only see non-type template parameters and type
//      template parameters
//
